...
<form method="POST" id="form-prospecto" action="">
    ...
    <div id="submodal-costos" class="modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:11000;">
        <div class="modal-content" style="max-width: 1600px; width: 95%; margin: 1.5rem auto; background: white; border-radius: 8px; padding: 1.5rem; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
            ...
            <!-- Labels descriptivos -->
            <div style="display: grid; grid-template-columns: repeat(11, 1fr); gap: 0.5rem; margin: 0.8rem 0; font-weight: bold; font-size: 0.85rem; color: #495057;">
                <div>Concepto</div>
                <div>Moneda</div>
                <div>Qty</div>
                <div>% Concepto</div>
            ...
            <div style="display: grid; grid-template-columns: 30ch 8ch 8ch 10ch 13ch 13ch 13ch 13ch 30ch 16ch; gap: 0.5rem; margin: 0.5rem 0; align-items: center; background: #f8f9fa; padding: 1rem; border-radius: 6px;">
                ...
                <table id="tabla-costos" style="width: 100%; border-collapse: collapse; font-size: 0.92rem;">
                    <thead>
                        <tr style="background: #f1f3f5;">
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; font-size: 0.92rem; width: auto; min-width: 30ch;">Concepto</th>
                            ...
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; background-color: #fff9db; font-size: 0.92rem; width: 13ch;">Costo</th>
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; background-color: #fff9db; font-size: 0.92rem; width: 13ch;">Total Costo</th>
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; background-color: #e6f7ff; font-size: 0.92rem; width: 13ch;">Tarifa</th>
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; background-color: #e6f7ff; font-size: 0.92rem; width: 13ch;">Total Tarifa</th>
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; font-size: 0.92rem; width: auto; min-width: 30ch;">Aplica</th>
                            <th style="padding: 0.6rem; text-align: center; border: 1px solid #ddd; font-size: 0.92rem; width: 16ch;">Acción</th>
                        </tr>
                    </thead>
