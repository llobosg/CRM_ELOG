<?php
    ...
    if (isset($_GET['seleccionar']) && is_numeric($_GET['seleccionar'])) {
        ...
        try {
            ...
            if ($prospecto_data) {
                // Cargar servicios
                $stmt_serv = $pdo->prepare("SELECT * FROM servicios WHERE id_ppl = ? ORDER BY id_srvc");
        ...
        <form method="POST" id="form-prospecto" action="">
            ...
            <script>
                ...
                function cargarProspectoDesdeURL() {
                    ...
                    // Llenar campos ocultos (con verificación)
                    const fields = [
                        { id: 'id_ppl', value: PROSPECTO_CARGADO.id_ppl },
                        { id: 'id_prospect', value: PROSPECTO_CARGADO.id_prospect },
                        { id: 'razon_social', value: PROSPECTO_CARGADO.razon_social },
                        { id: 'notas_comerciales', value: PROSPECTO_CARGADO.notas_comerciales },
                        { id: 'notas_operaciones', value: PROSPECTO_CARGADO.notas_operaciones },
                        { id: 'concatenado', value: PROSPECTO_CARGADO.concatenado }
                    ];
                    ...
                    if (fechaAlta && PROSPECTO_CARGADO.fecha_alta) {
                        fechaAlta.value = PROSPECTO_CARGADO.fecha_alta;
                    }
                    const fechaEstado = document.getElementById('fecha_estado');
                    if (fechaEstado && PROSPECTO_CARGADO.fecha_estado) {
                        fechaEstado.value = PROSPECTO_CARGADO.fecha_estado;
                    }
                ...
                function reiniciarFormProspecto() {
                    ...
                    const tieneNotas = (document.getElementById('notas_comerciales')?.value || '').trim() !== '' ||
                                    (document.getElementById('notas_operaciones')?.value || '').trim() !== '';

                    if (tieneId || tieneServicios || tieneNotas) {
